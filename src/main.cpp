...
const string strMessageMagic = "LionCoin Signed Message:\n";
      ...
      if(nBestHeight < 200)
        {
            ...
            else if(nBestHeight < 400)
        {
            nSubsidy = 10 * COIN;
        }
            else if(nBestHeight < 600)
        {
            nSubsidy = 100 * COIN;
        }
            else if(nBestHeight < 7000)
        {
            nSubsidy = 1000 * COIN;
        }
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "LionCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "20141028";
        CTransaction txNew;
        txNew.nTime = 1406822400;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0xb1fbc59cfb3921ecf99ae5588728b1884d4c15bbb539ddeac10798255b7b138d"));
        block.print();
